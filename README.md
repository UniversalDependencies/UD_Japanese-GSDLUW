...
We use the **LUW** as the UD word tokenization in this resource.
...
XPOS is the part-of-speech label for Long Unit Word (LUW) based on UniDic POS tagset [7].
...
* 2017-03-01 v2.0 (UD_Japanese-GSD)
  * Converted to UD v2 guidelines.
  
* 2016-11-15 v1.4 (UD_Japanese-GSD)
